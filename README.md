...
## License
This is free and unencumbered software released into the public domain. You may read the full license [here](https://github.com/lightbulblighter/blob/main/LICENSE) for more info.